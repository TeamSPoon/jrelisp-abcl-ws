...
/**
 * An instance of this class represents a match completed by a gnu.regexp
 * matching function. It can be used to obtain relevant information about the
 * location of a match or submatch.
 *
...
public final class REMatch implements Serializable, Cloneable {
	...
	/**
	 * Returns the string matching the pattern. This makes it convenient to
	 ...
	 * identified by the first set of parentheses in a regular expression could
	 * be retrieved from an REMatch by calling match.toString(1).
	 *
	 * @param sub
	 *            Index of the subexpression.
	 */
	public String toString(int sub) {
		if ((sub >= start.length) || (start[sub] == -1))
			return "";
	 ...
	 * where subexpression number <i>sub</i> begins, or <code>-1</code> if the
	 * subexpression does not exist. The initial position is zero.
	 *
	 * @param sub
	 *            Subexpression index
	...
	/**
	 * Returns the index within the input string used to generate this match
	 * where subexpression number <i>sub</i> ends, or <code>-1</code> if the
	 * subexpression does not exist. The initial position is zero.
	 *
	 * @param sub
	 *            Subexpression index
	...
	/**
	 * Substitute the results of this match to create a new string. This is
	 * patterned after PERL, so the tokens to watch out for are <code>$0</code>
	 * through <code>$9</code>. <code>$0</code> matches the full substring
	 * matched; <code>$<i>n</i></code> matches subexpression number <i>n</i>.
	 *
	 * @param input
	 *            A string consisting of literals and <code>$<i>n</i></code>
	 *            tokens.
	 */
