...
public class REFilterReader extends FilterReader {
	...
	/**
	 * Creates an REFilterReader. When reading from this stream, occurrences of
	 * patterns matching the supplied regular expression will be replaced with
	 * the supplied replacement text (the metacharacters $0 through $9 may be
	 * used to refer to the full match or subexpression matches.
	 *
	 * @param stream
	...
	/**
	 * Returns false. REFilterReader does not support mark() and reset()
	 * methods.
	 */
