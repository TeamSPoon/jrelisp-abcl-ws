 ...
 * <LI>An integral type code equivalent to one of the statically defined symbols
 * listed below.
 * <LI>The approximate position in the input string where the error occurred.
 * </OL>
 *
...
public class REException extends Exception {
	...
	/**
	 * Error flag. Invalid use of the range operator, eg. the ending point of
	...
	/**
	 * Error flag. Compiled regular expression requires a pattern buffer larger
	 * than 64Kb. <B>Not implemented</B>.
	 */
	...
	/**
	 * Reports the descriptive message associated with this exception as well as
	 * its index position in the string or character array being compiled.
	 */
