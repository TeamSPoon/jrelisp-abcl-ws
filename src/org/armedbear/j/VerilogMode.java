 ...
 * $Id: VerilogMode.java,v 1.1.1.1 2002/09/24 16:07:56 piso Exp $
 *
...
public final class VerilogMode extends AbstractMode implements Constants, Mode {
	...
	private static final String[] alwaysIndentAfter = { "begin", "case", "casex", "casez", "fork", "function",
			"generate", "module", "primitive", "specify", "table", "task" };

	private static final String[] maybeIndentAfter = { "always", "else", "for", "forever", "if", "initial", "repeat",
			"while" };
}
