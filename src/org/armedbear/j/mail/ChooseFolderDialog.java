 ...
 * $Id: ChooseFolderDialog.java,v 1.1.1.1 2002/09/24 16:10:04 piso Exp $
 *
...
public final class ChooseFolderDialog extends InputDialog {
	...
	public static String chooseFolder(Editor editor, String prompt, String title) {
		String errorText = null;
		while (true) {
			if (errorText != null)
				MessageDialog.showMessageDialog(editor, errorText, title);
			ChooseFolderDialog dialog = new ChooseFolderDialog(editor, prompt, title);
