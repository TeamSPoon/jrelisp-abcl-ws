...
public final class SortByThread {
			...
			if (entry != null) {
				...
				if (baseSubject != null && baseSubject.length() > 0) {
					...
					if (oldNode == null) {
						...
						if (oldEntry != null && oldEntry.subjectIsReply() && !entry.subjectIsReply()) {
							subjectMap.put(baseSubject, node);
	...
	private void addEntriesForNode(Node node, Mailbox mb, MailboxFilter filter, int depth) {
		if (node != root) {
			MailboxEntry entry = node.getMailboxEntry();
			if (entry != null) {
...
class Node extends DefaultMutableTreeNode {
	...
	private static final Comparator comparator = new Comparator() {
		public int compare(Object o1, Object o2) {
			return RFC822Date.compare(((Node) o1).getDate(), ((Node) o2).getDate());
		}
	};
