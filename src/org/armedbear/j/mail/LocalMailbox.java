	...
	protected boolean rewriteMailbox(boolean purge) {
		...
		try {
			BufferedReader reader = new BufferedReader(
					new InputStreamReader(mailboxFile.getInputStream(), "ISO8859_1"));
			File tempFile = Utilities.getTempFile(mailboxFile.getParentFile());
			BufferedWriter writer = new BufferedWriter(new OutputStreamWriter(tempFile.getOutputStream(), "ISO8859_1"));
