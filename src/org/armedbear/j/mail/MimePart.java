...
public class MimePart {
	...
	public String getDecodedBody() {
		...
		final String charset = Utilities.getCharsetFromContentType(getHeaderValue(Headers.CONTENT_TYPE));
		final String characterEncoding = Utilities.getEncodingFromCharset(charset);
		if (contentType == null || contentType.toLowerCase().startsWith("text/")) {
			if (transferEncoding == null || transferEncoding.equals("7bit") || transferEncoding.equals("8bit")
	...
	public String getAttachmentFileName() {
		String filename = getHeaderParameter(Headers.CONTENT_DISPOSITION, "filename");
		if (filename == null)
	...
	public File cacheDecoded() {
		...
		File cache = Utilities.getTempFile(Directories.getTempDirectory(), extension);
	...
	public void parse() {
		...
		if (contentType.toLowerCase().startsWith("multipart/")) {
			...
			String boundary = contentType.substring(index + BOUNDARY_START.length()).trim();
