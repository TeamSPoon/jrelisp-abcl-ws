 ...
 * $Id: Base64Decoder.java,v 1.1.1.1 2002/09/24 16:09:56 piso Exp $
 *
...
public final class Base64Decoder {
	...
	public static boolean decode(String input, OutputStream outputStream) throws IOException {
	...
	private static boolean decode(String input, int offset, OutputStream out) throws IOException {
	...
	// in transit)."
	private static boolean decodeFinal(String input, int offset, OutputStream out) throws IOException {
		byte b0 = 0;
		byte b1 = 0;
		byte b2 = 0;
		byte b3 = 0;
	...
	private static final byte values[] = { BAD, BAD, BAD, BAD, BAD, BAD, BAD, BAD, // 0x00-0x07
