 ...
 * $Id: OrTerm.java,v 1.1.1.1 2002/09/24 16:10:11 piso Exp $
 *
...
public final class OrTerm extends MailboxFilter {
	private final ArrayList filters;

	public OrTerm(MailboxFilter first, MailboxFilter second) {
