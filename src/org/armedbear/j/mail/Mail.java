...
public final class Mail {
	...
	public static boolean bounceMessage(Message message, MailAddress[] to, SmtpSession session) {
		if (message == null)
			return false;
		if (to == null)
			return false;
	...
	private static boolean writeMessageText(Message message, MailAddress[] to, Writer writer) {
		try {
			FastStringReader reader = new FastStringReader(message.getRawHeaders());
			String s;
