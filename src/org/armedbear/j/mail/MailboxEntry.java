...
public abstract class MailboxEntry implements Serializable {
	...
	private static final boolean DEBUG = Editor.preferences().getBooleanProperty("MailboxEntry.debug", false);

	protected static final boolean SHOW_MESSAGE_NUMBERS = Editor.preferences()
			.getBooleanProperty(Property.SHOW_MESSAGE_NUMBERS);
	...
	private static final SimpleDateFormat dateFormat1 = new SimpleDateFormat("MMM dd HH:mm", Locale.US);

	private static final SimpleDateFormat dateFormat2 = new SimpleDateFormat("MMM dd  yyyy", Locale.US);
