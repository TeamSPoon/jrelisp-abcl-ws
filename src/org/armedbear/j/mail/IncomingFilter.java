 ...
 * $Id: IncomingFilter.java,v 1.1.1.1 2002/09/24 16:09:44 piso Exp $
 *
...
public final class IncomingFilter {
	...
	private IncomingFilter(String mailbox, String pattern, MailboxFilter filter, int action, String parameter) {
	...
	public static synchronized void addIncomingFilter(String mailbox, String pattern, String actionName,
			String parameter) {
		if (mailbox == null)
			return;
		if (pattern == null)
		...
		if (actionName.equalsIgnoreCase("move"))
			...
			Log.error("addIncomingFilter - action \"" + actionName + "\" is not supported");
			return;
		}
		if (filterList == null)
			filterList = new ArrayList();
		filterList.add(new IncomingFilter(mailbox, pattern, filter, action, parameter));
	}
