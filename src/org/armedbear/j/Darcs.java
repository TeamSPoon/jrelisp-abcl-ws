...
public class Darcs implements Constants {
	...
	private static void darcsCompleted(Editor editor, Buffer parentBuffer, String cmd, String output) {
	...
	private static boolean checkDarcsInstalled() {
		if (haveDarcs())
			return true;
		MessageDialog.showMessageDialog("The darcs command-line client does not appear to be in your PATH.", "Error");
		return false;
	}
