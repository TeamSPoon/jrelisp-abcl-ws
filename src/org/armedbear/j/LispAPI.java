...
public final class LispAPI extends Lisp {
	/* removal of synthetic method (was private) */
	static final Preferences preferences = Editor.preferences();

	public static final Package PACKAGE_J = Packages.createPackage("J");
	public static final Package PACKAGE_J_INTERNALS = Packages.createPackage("J-INTERNALS");
	...
	public static final Symbol BUFFER_STREAM = LispAPI.PACKAGE_J.addExternalSymbol("BUFFER-STREAM");

	public static final Symbol _CURRENT_COMMAND_ = exportSpecial("*CURRENT-COMMAND*", PACKAGE_J, NIL);

	public static final Symbol _LAST_COMMAND_ = exportSpecial("*LAST-COMMAND*", PACKAGE_J, NIL);
...

	{
		...
		try {
			...
			error(new TypeError("The value " + obj.writeToString() + " is not an editor."));
			// Not reached.
			return null;
		}
	}
...

	{
		...
		try {
			...
			error(new TypeError("The value " + obj.writeToString() + " is not a buffer."));
			// Not reached.
			return null;
		}
	}
...

	{
		...
		try {
			...
			error(new TypeError("The value " + obj.writeToString() + " is not a keymap."));
			// Not reached.
			return null;
		}
	}
	...
	/* removal of synthetic method (was private) */
	static final Position checkMark(LispObject obj)

	{
		...
		try {
			...
			error(new TypeError("The value " + obj.writeToString() + " is not a mark."));
			// Not reached.
			return null;
		}
	}
...

	{
		...
		try {
			...
			error(new TypeError("The value " + obj.writeToString() + " is not a line."));
			// Not reached.
			return null;
		}
	}
	...
	// ### current-editor
	private static final Primitive CURRENT_EDITOR = new Primitive("current-editor", PACKAGE_J, true, "",
	...
	// ### %set-current-editor
	private static final Primitive _SET_CURRENT_EDITOR = new Primitive("%set-current-editor", PACKAGE_J, false,
			"(EDITOR)", "Makes EDITOR the current editor.") {
	...
	// ### other-editor
	private static final Primitive OTHER_EDITOR = new Primitive("other-editor", PACKAGE_J, true) {
		public LispObject execute() {
	...
	// ### current-buffer
	private static final Primitive CURRENT_BUFFER = new Primitive("current-buffer", PACKAGE_J, true) {
		public LispObject execute() {
	...
	private static final Primitive BUFFER = new Primitive("editor-buffer", PACKAGE_J, true) {
		public LispObject execute(LispObject arg) {
	...
	// ### buffer-name
	private static final Primitive BUFFER_NAME = new Primitive("buffer-name", PACKAGE_J, true, "&optional buffer") {
		public LispObject execute() {
	...
	// ### set-buffer-name
	private static final Primitive SET_BUFFER_NAME = new Primitive("set-buffer-name", PACKAGE_J, true, "buffer name") {
	...
	// ### get-buffer
	private static final Primitive GET_BUFFER = new Primitive("get-buffer", PACKAGE_J, true, "name") {
		public LispObject execute(LispObject arg) {
	...
	private static final Primitive BUFFER_LIVE_P = new Primitive("buffer-live-p", PACKAGE_J, true, "object") {
		public LispObject execute(LispObject arg) {
			if (arg instanceof JavaObject) {
				if (((JavaObject) arg).getObject() instanceof Buffer) {
	...
	// ### buffer-pathname
	private static final Primitive BUFFER_PATHNAME = new Primitive("buffer-pathname", PACKAGE_J, true,
			"&optional buffer") {
		public LispObject execute() {
	...
	// ### buffer-string
	private static final Primitive BUFFER_STRING = new Primitive("buffer-string", PACKAGE_J, true, "&optional buffer") {
		public LispObject execute() {
	...
	// ### buffer-substring
	private static final Primitive BUFFER_SUBSTRING = new Primitive("buffer-substring", PACKAGE_J, true,
			"start end &optional buffer") {
		public LispObject execute(LispObject first, LispObject second)

		{
			Region region = new Region(Editor.currentEditor().getBuffer(), checkMark(first), checkMark(second));
	...
	private static final Primitive BUFFER_OFFSET = new Primitive("buffer-offset", PACKAGE_J, true,
			"mark &optional buffer") {
		public LispObject execute(LispObject arg) {
	...
	// ### goto-char position
	private static final Primitive GOTO_CHAR = new Primitive("goto-char", PACKAGE_J, true) {
		public LispObject execute(LispObject arg) {
	...
	private static final Primitive MOVE_TO_POSITION = new Primitive("move-to-position", PACKAGE_J, true,
		...
		public LispObject execute(LispObject mark, LispObject charpos, LispObject line)
	...
	// ### current-point
	private static final Primitive CURRENT_POINT = new Primitive("current-point", PACKAGE_J, true, "") {
		public LispObject execute() {
	...
	// ### current-mark
	private static final Primitive CURRENT_MARK = new Primitive("current-mark", PACKAGE_J, true, "") {
		public LispObject execute() {
	...
	private static final Primitive BUFFER_MARK = new Primitive("buffer-mark", PACKAGE_J, true) {
		public LispObject execute(LispObject arg)
	...
	private static final Primitive _SET_BUFFER_MARK = new Primitive("%set-buffer-mark", PACKAGE_J, true) {
		public LispObject execute(LispObject first, LispObject second)
	...
	private static final Primitive EDITOR_MARK = new Primitive("editor-mark", PACKAGE_J, true) {
		public LispObject execute(LispObject arg)
	...
	private static final Primitive _SET_EDITOR_MARK = new Primitive("%set-editor-mark", PACKAGE_J, true) {
		public LispObject execute(LispObject first, LispObject second)
	...
	// ### point-min
	private static final Primitive POINT_MIN = new Primitive("point-min", PACKAGE_J, true) {
		public LispObject execute() {
	...
	// ### point-max
	private static final Primitive POINT_MAX = new Primitive("point-max", PACKAGE_J, true) {
		public LispObject execute() {
	...
	// ### make-mark
	private static final Primitive MAKE_MARK = new Primitive("make-mark", PACKAGE_J, true, "line offset") {
		public LispObject execute(LispObject first, LispObject second)
	...
	// ### mark-line
	private static final Primitive MARK_LINE = new Primitive("mark-line", PACKAGE_J, true, "mark") {
		public LispObject execute(LispObject arg) {
	...
	// ### mark-charpos
	private static final Primitive MARK_CHARPOS = new Primitive("mark-charpos", PACKAGE_J, true, "mark") {
		public LispObject execute(LispObject arg) {
	...
	// ### current-line
	private static final Primitive CURRENT_LINE = new Primitive("current-line", PACKAGE_J, true) {
		public LispObject execute() {
	...
	// ### line-next
	private static final Primitive LINE_NEXT = new Primitive("line-next", PACKAGE_J, true) {
		public LispObject execute(LispObject arg) {
	...
	// ### line-previous
	private static final Primitive LINE_PREVIOUS = new Primitive("line-previous", PACKAGE_J, true) {
		public LispObject execute(LispObject arg) {
	...
	// ### line-chars
	private static final Primitive LINE_CHARS = new Primitive("line-chars", PACKAGE_J, true) {
		public LispObject execute(LispObject arg) {
	...
	// ### line-flags
	private static final Primitive LINE_FLAGS = new Primitive("line-flags", PACKAGE_J, true) {
		public LispObject execute(LispObject arg) {
	...
	// ### %set-line-flags
	private static final Primitive _SET_LINE_FLAGS = new Primitive("%set-line-flags", PACKAGE_J, false) {
		public LispObject execute(LispObject first, LispObject second)
	...
	// ### line-number
	private static final Primitive LINE_NUMBER = new Primitive("line-number", PACKAGE_J, true, "line") {
		public LispObject execute(LispObject arg) {
	...
	private static final Primitive CHAR_AFTER = new Primitive("char-after", PACKAGE_J, true) {
		public LispObject execute(LispObject arg) {
	...
	private static final Primitive CHAR_BEFORE = new Primitive("char-before", PACKAGE_J, true) {
		public LispObject execute(LispObject arg) {
	...
	private static final Primitive FORWARD_CHAR = new Primitive("forward-char", PACKAGE_J, true,
			"mark &optional count") {
		public LispObject execute(LispObject arg) {
	...
	private static final Primitive BACKWARD_CHAR = new Primitive("backward-char", PACKAGE_J, true,
			"mark &optional count") {
		public LispObject execute(LispObject arg) {
			Position pos = checkMark(arg);
			return forwardChar(pos, -1);
	...
	// ### beginning-of-line
	private static final Primitive BEGINNING_OF_LINE = new Primitive("beginning-of-line", PACKAGE_J, true) {
		public LispObject execute() {
	...
	// ### end-of-line
	private static final Primitive END_OF_LINE = new Primitive("end-of-line", PACKAGE_J, true) {
		public LispObject execute() {
	...
	private static final Primitive BACKWARD_UP_LIST = new Primitive("backward-up-list", PACKAGE_J, true, "mark") {
		public LispObject execute(LispObject arg) {
			Position pos = checkMark(arg);
	...
	private static final Primitive LOOKING_AT = new Primitive("looking-at", PACKAGE_J, true, "mark string") {
		public LispObject execute(LispObject first, LispObject second)
	...
	// ### kill-theme
	private static final Primitive KILL_THEME = new Primitive("kill-theme", PACKAGE_J, true) {
		public LispObject execute() {
	...
	// ### restore-focus
	private static final Primitive RESTORE_FOCUS = new Primitive("restore-focus", PACKAGE_J, true) {
		public LispObject execute() {
	...
	// ### make-keymap
	private static final Primitive MAKE_KEYMAP = new Primitive("make-keymap", PACKAGE_J, true, "") {
		public LispObject execute() {
			return new JavaObject(new KeyMap());
		}
	};

	public static final Symbol _CURRENT_GLOBAL_MAP_ = exportSpecial("*CURRENT-GLOBAL-MAP*", PACKAGE_J, NIL);

	// ### current-global-map
	private static final Primitive CURRENT_GLOBAL_MAP = new Primitive("current-global-map", PACKAGE_J, true, "") {
		public LispObject execute() {
	...
	private static final Primitive USE_GLOBAL_MAP = new Primitive("use-global-map", PACKAGE_J, true, "keymap") {
		public LispObject execute(LispObject arg)

		{
			if (arg != NIL)
				KeyMap.setGlobalKeyMap(checkKeymap(arg));
			LispThread.currentThread().setSpecialVariable(_CURRENT_GLOBAL_MAP_, arg);
			return NIL; // emacs
		}
	};

	// ### define-key keymap key definition => generalized-boolean
	private static final Primitive DEFINE_KEY = new Primitive("define-key", PACKAGE_J, true,
			"keymap key-designator definition") {
		public LispObject execute(LispObject first, LispObject second, LispObject third)

		{
			KeyMap keymap = checkKeymap(first);
			if (!(second instanceof LispCharacter || second instanceof AbstractString))
				return type_error(second, list2(Symbol.OR, list2(Symbol.CHARACTER, Symbol.STRING)));
			Object command;
	...
	private static final Primitive GLOBAL_MAP_KEY = new Primitive("global-map-key", PACKAGE_J, true, "key command") {
		public LispObject execute(LispObject first, LispObject second)
	...
	private static final Primitive GLOBAL_UNMAP_KEY = new Primitive("global-unmap-key", PACKAGE_J, true, "key") {
		public LispObject execute(LispObject arg)
	...
	private static final Primitive MAP_KEY_FOR_MODE = new Primitive("map-key-for-mode", PACKAGE_J, true,
			"key command mode") {
		public LispObject execute(LispObject first, LispObject second, LispObject third)
	...
	private static final Primitive UNMAP_KEY_FOR_MODE = new Primitive("unmap-key-for-mode", PACKAGE_J, true,
			"key mode") {
		public LispObject execute(LispObject first, LispObject second)
	...
	// ### set-global-property
	private static final Primitive SET_GLOBAL_PROPERTY = new Primitive("set-global-property", PACKAGE_J, true,
			"key value") {
		public LispObject execute(LispObject first, LispObject second)

		{
			...
			if (property.isBooleanProperty()) {
				preferences.setProperty(property, (second == NIL) ? "false" : "true");
				return second;
			}
			if (property.isIntegerProperty()) {
				if (second instanceof Fixnum) {
					preferences.setProperty(property, String.valueOf(((Fixnum) second).value));
					return second;
				}
				if (second instanceof AbstractString) {
					int value;
					try {
						...
						return error(new LispError(second.writeToString() + " cannot be converted to a Java integer."));
					}
	...
	// ### set-mode-property
	private static final Primitive SET_MODE_PROPERTY = new Primitive("set-mode-property", PACKAGE_J, true,
			"key value mode") {
		public LispObject execute(LispObject first, LispObject second, LispObject third)

		{
			...
			final Mode mode = Editor.getModeList().getModeFromModeName(third.getStringValue());
			if (mode == null)
				return error(new LispError(third.writeToString() + " does not designate any mode."));
			Property property = Property.findProperty(key);
			if (property == null)
				// Not an advertised property.
				return error(new LispError(first.writeToString() + " does not designate any property."));
			if (property.isBooleanProperty()) {
				...
				return type_error(second, list3(Symbol.OR, Symbol.FIXNUM, Symbol.STRING));
			}
			// It must be a string property.
			if (!(second instanceof AbstractString))
				return type_error(second, Symbol.STRING);
	...
	// ### set-buffer-property
	private static final Primitive SET_BUFFER_PROPERTY = new Primitive("set-buffer-property", PACKAGE_J, true,
			"key value &optional buffer") {
		public LispObject execute(LispObject first, LispObject second)

		{
			return execute(first, second, new JavaObject(Editor.currentEditor().getBuffer()));
		}
	...
	private static final Primitive GET_GLOBAL_PROPERTY = new Primitive("get-global-property", PACKAGE_J, true, "key") {
		public LispObject execute(LispObject arg) {
			String key = javaString(arg);
			Property property = Property.findProperty(key);
			if (property == null) {
				// Not an advertised property.
				return error(new LispError(arg.writeToString() + " does not designate a property."));
			}
			if (property.isBooleanProperty())
	...
	private static final Primitive GET_BUFFER_PROPERTY = new Primitive("get-buffer-property", PACKAGE_J, true,
			"key &optional buffer") {
		public LispObject execute(LispObject arg) {
			return execute(arg, new JavaObject(Editor.currentEditor().getBuffer()));
		}
	...
	// ### insert
	private static final Primitive INSERT = new Primitive("insert", PACKAGE_J, true, "&rest args") {
			...
			try {
				for (int i = 0; i < args.length; i++) {
					...
					if (obj instanceof LispCharacter) {
						...
						return type_error(obj, list3(Symbol.OR, Symbol.CHARACTER, Symbol.STRING));
				}
				return NIL;
			} finally {
	...
	// ### delete-region => nil
	private static final Primitive DELETE_REGION = new Primitive("delete-region", PACKAGE_J, true) {
		public LispObject execute() {
			final Editor editor = Editor.currentEditor();
			if (!editor.checkReadOnly())
				return NIL;
	...
	// ### set-mark pos => pos
	private static final Primitive SET_MARK = new Primitive("set-mark", PACKAGE_J, true) {
		public LispObject execute(LispObject arg) {
			final Editor editor = Editor.currentEditor();
			if (arg != NIL)
	...
	// ### copy-mark mark => copy
	private static final Primitive COPY_MARK = new Primitive("copy-mark", PACKAGE_J, true, "mark") {
		public LispObject execute(LispObject arg) {
			Position pos = checkMark(arg);
	...
	private static final Primitive MARK_EQUAL = new Primitive("mark=", PACKAGE_J, true, "mark1 mark2") {
		public LispObject execute(LispObject first, LispObject second)
	...
	// ### undo
	private static final Primitive UNDO = new Primitive("undo", PACKAGE_J, true, "&optional count") {
		public LispObject execute() {
	...
	// ### begin-compound-edit
	private static final Primitive BEGIN_COMPOUND_EDIT = new Primitive("begin-compound-edit", PACKAGE_J, false) {
		public LispObject execute() {
	...
	// ### end-compound-edit
	private static final Primitive END_COMPOUND_EDIT = new Primitive("end-compound-edit", PACKAGE_J, false) {
		public LispObject execute(LispObject arg) {
			try {
				CompoundEdit compoundEdit = (CompoundEdit) ((JavaObject) arg).getObject();
				Editor.currentEditor().endCompoundEdit(compoundEdit);
				return NIL;
			} catch (ClassCastException e) {
				return error(new LispError(arg.writeToString() + " does not designate a compound edit."));
			}
		}
	};

	// ### %log-debug
	private static final Primitive _LOG_DEBUG = new Primitive("%log-debug", PACKAGE_J, false) {
		public LispObject execute(LispObject arg) {
	...
	// ### get-last-event-time
	private static final Primitive GET_LAST_EVENT_INTERNAL_TIME = new Primitive("get-last-event-internal-time",
			PACKAGE_J, true) {
		public LispObject execute() {
	...
	public static void invokeOpenFileHook(Buffer buffer) {
		try {
			Primitives.FUNCALL.execute(PACKAGE_J.intern("INVOKE-HOOK"), PACKAGE_J.intern("OPEN-FILE-HOOK"),
	...
	public static void invokeBufferActivatedHook(Buffer buffer) {
		if (buffer != null) {
			try {
				Primitives.FUNCALL.execute(PACKAGE_J.intern("INVOKE-HOOK"), PACKAGE_J.intern("BUFFER-ACTIVATED-HOOK"),
						new JavaObject(buffer));
			} catch (Throwable t) {
				Log.debug(t);
			}
	...
	public static void invokeAfterSaveHook(Buffer buffer) {
		try {
			Primitives.FUNCALL.execute(PACKAGE_J.intern("INVOKE-HOOK"), PACKAGE_J.intern("AFTER-SAVE-HOOK"),
					new JavaObject(buffer));
		} catch (Throwable t) {
			Log.debug(t);
		}
	...
	public static void invokeLispShellStartupHook(Buffer buffer, String command) {
		try {
			Primitives.FUNCALL.execute(PACKAGE_J.intern("INVOKE-HOOK"), PACKAGE_J.intern("LISP-SHELL-STARTUP-HOOK"),
					new JavaObject(buffer), new SimpleString(command));
		} catch (Throwable t) {
			Log.debug(t);
		}
	}
	...
	// ### invoke-later
	public static final Primitive INVOKE_LATER = new Primitive("invoke-later", PACKAGE_J, true) {
		public LispObject execute(LispObject arg) {
	...
	private static final Primitive MAKE_BUFFER_STREAM = new Primitive("make-buffer-stream", PACKAGE_J, true) {
		public LispObject execute() {
	...
	private static final Primitive BUFFER_STREAM_BUFFER = new Primitive("buffer-stream-buffer", PACKAGE_J, true) {
		public LispObject execute(LispObject arg) {
			if (arg instanceof BufferStream)
				return new JavaObject(((BufferStream) arg).getBuffer());
			return error(new LispError(arg.writeToString() + "does not designate a buffer stream."));
		}
	};

	// ### pop-to-buffer buffer => buffer
	private static final Primitive POP_TO_BUFFER = new Primitive("pop-to-buffer", PACKAGE_J, true) {
		public LispObject execute(LispObject arg) {
			if (arg != NIL) {
	...
	private static final Primitive SWITCH_TO_BUFFER = new Primitive("switch-to-buffer", PACKAGE_J, true) {
		public LispObject execute(LispObject arg) {
			Buffer buffer = checkBuffer(arg);
			Editor editor = Editor.currentEditor();
			editor.makeNext(buffer);
	...
	private static final Primitive BUFFER_MODIFIED_P = new Primitive("buffer-modified-p", PACKAGE_J, true, "buffer") {
		public LispObject execute(LispObject arg) {
	...
	private static final Primitive SET_BUFFER_MODIFIED_P = new Primitive("set-buffer-modified-p", PACKAGE_J, true,
			"buffer flag") {
		public LispObject execute(LispObject first, LispObject second)
	...
	private static final Primitive STATUS = new Primitive("status", PACKAGE_J, true, "string &optional editor") {
		public LispObject execute(LispObject arg) {
			if (arg instanceof AbstractString) {
	...
	// ### %search
	private static final Primitive _SEARCH = new Primitive("%search", PACKAGE_J, false,
		...
		public LispObject execute(LispObject[] args) {
			...
			if (args[2] != NIL) {
				try {
					...
					return error(new LispError("Invalid regular expression: \"" + pattern + '"'));
				}
				if (backward)
	...
	private static final Primitive FIND_BEGINNING_OF_DEFUN = new Primitive("find-beginning-of-defun", PACKAGE_J, true,
			"&optional mark") {
		public LispObject execute() {
			Position pos = LispMode.findBeginningOfDefun(Editor.currentEditor().getDot());
			return pos != null ? new JavaObject(pos) : NIL;
		}
	...
	private static final Primitive DEFUN_AT_POINT = new Primitive("defun-at-point", PACKAGE_J, true, "") {
		public LispObject execute() {
	...
	// ### forward-sexp
	private static final Primitive FORWARD_SEXP = new Primitive("forward-sexp", PACKAGE_J, true, "") {
		public LispObject execute() {
	...
	// ### backward-sexp
	private static final Primitive BACKWARD_SEXP = new Primitive("backward-sexp", PACKAGE_J, true, "") {
		public LispObject execute() {
