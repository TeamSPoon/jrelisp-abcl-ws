...
public class AboutDialog extends AbstractDialog {
	...
	public AboutDialog() {
		...
		addStaticText(panel, "Copyright (C) 1998-2009 Peter Graves (peter@armedbear.org)");
		addStaticText(panel, "J is free software; see the source for copying conditions.");
