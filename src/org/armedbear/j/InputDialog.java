...
public class InputDialog extends JDialog implements KeyListener {
	...
	public InputDialog(Editor editor, String prompt, String title, String defaultValue) {
	...
	public static String showInputDialog(Editor editor, String prompt, String title, String defaultValue) {
	...
	public static String showInputDialog(Editor editor, String prompt, String title) {
