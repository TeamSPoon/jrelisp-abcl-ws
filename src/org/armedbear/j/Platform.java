...
public final class Platform {
	...
	private static final boolean isPlatformUnix = isPlatformLinux || osName.startsWith("Mac OS X")
			|| osName.startsWith("Solaris") || isPlatformSunOS || isPlatformFreeBSD || osName.startsWith("AIX");
	private static final boolean isPlatformWindows = osName.startsWith("Windows");
	private static final boolean isPlatformMacOSX = osName.startsWith("Mac OS X");
	private static final boolean isJava13 = System.getProperty("java.version").startsWith("1.3");
	private static final boolean isJava14 = System.getProperty("java.version").startsWith("1.4");
	private static final boolean isJava140 = System.getProperty("java.version").startsWith("1.4.0");
