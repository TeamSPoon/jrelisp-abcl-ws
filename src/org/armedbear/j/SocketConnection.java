 ...
 * $Id: SocketConnection.java,v 1.1.1.1 2002/09/24 16:07:54 piso Exp $
 *
...
public final class SocketConnection {
	...
	public SocketConnection(String hostName, int port, int timeout, int checkInterval, Cancellable client) {
