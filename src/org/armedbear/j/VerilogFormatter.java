 ...
 * $Id: VerilogFormatter.java,v 1.1.1.1 2002/09/24 16:08:14 piso Exp $
 *
...
public final class VerilogFormatter extends Formatter implements Constants {
	...
	private static String[] compilerDirectives = { "`autoexpand_vectornets", "`celldefine", "`default_nettype",
			"`define", "`delay_mode_distributed", "`delay_mode_path", "`delay_mode_unit", "`delay_mode_zero", "`else",
			"`endcelldefine", "`endif", "`endprotect", "`endprotected", "`expand_vectornets", "`ifdef", "`ifndef",
			"`include", "`noexpand_vectornets", "`noremove_gatename", "`noremove_netname", "`nounconnected_drive",
			"`protect", "`protected", "`remove_gatename", "`remove_netname", "`reset_all", "`signed", "`timescale",
			"`unconnected_drive", "`undef", "`unsigned", "`uselib" };
}
