 ...
 * $Id: HttpFile.java,v 1.1.1.1 2002/09/24 16:08:24 piso Exp $
 *
...
public final class HttpFile extends File {
	...
	public static HttpFile getHttpFile(HttpFile directory, String name) {
		if (name.startsWith("http://") || name.startsWith("https://")) {
			...
			return new HttpFile(directory.hostName,
					canonicalize(appendNameToPath(directory.canonicalPath(), name, '/'), "/"), directory.protocol,
					directory.port);
		}
	}
	...
	public File getParentFile() {
		...
		if (index < 0) {
			...
			return new HttpFile(hostName, stripped.substring(0, index), protocol, port);
		}
	}
