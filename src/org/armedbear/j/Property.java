...
public final class Property implements Comparable, Constants {
	...
	// Boolean properties.
	public static final Property ANTIALIAS = createProperty("antialias", false);
	...
	public static final Property FILENAME_COMPLETIONS_IGNORE_CASE = createProperty("filenameCompletionsIgnoreCase",
			true);
	...
	public static final Property POP_EXPUNGE_DELETED_MESSAGES_ON_SERVER = createProperty(
			"popExpungeDeletedMessagesOnServer", false);
	...
	public static final Property STATUS_BAR_DISPLAY_LINE_SEPARATOR = createProperty("StatusBar.displayLineSeparator",
			false);
	...
	public static final Property TOOL_BAR_SHOW_TEXT = createProperty("ToolBar.showText", true);
	...
	public static final Property DEFAULT_ENCODING = createProperty("defaultEncoding", "ISO-8859-1");
	...
	public static final Property SHELL_PROMPT_PATTERN = createProperty("shellPromptPattern",
			DEFAULT_SHELL_PROMPT_PATTERN);
	public static final Property SSH_PROMPT_PATTERN = createProperty("sshPromptPattern", DEFAULT_SHELL_PROMPT_PATTERN);
	public static final Property TELNET_PROMPT_PATTERN = createProperty("telnetPromptPattern",
			DEFAULT_SHELL_PROMPT_PATTERN);
	...
	public static final Property EXTENSION = createProperty("extension");
