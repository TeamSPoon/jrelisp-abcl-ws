...
public class ConfirmDialog extends MessageDialog implements Constants {
	...
	public static int showConfirmDialog(Editor editor, String text, String title) {
	...
	public static int showConfirmAllDialog(Editor editor, String text, String title) {
		ConfirmDialog d = new ConfirmDialog(editor);
		d.confirmAll = true;
		d.initialize(text, title);
		if (editor != null)
	...
	public static int showConfirmDialogWithCancelButton(Editor editor, String text, String title) {
		ConfirmDialog d = new ConfirmDialog(editor);
		d.cancel = true;
		d.initialize(text, title);
		if (editor != null)
