 ...
 * $Id: RecentFilesEntry.java,v 1.1.1.1 2002/09/24 16:08:34 piso Exp $
 *
...
public final class RecentFilesEntry {
	...
	public boolean matches(File file) {
		if (!name.equals(file.getName()))
			return false;
		if (location.startsWith(File.PREFIX_FTP) || location.startsWith(File.PREFIX_HTTP)
				|| location.startsWith(File.PREFIX_HTTPS) || location.startsWith(File.PREFIX_SSH)) {
