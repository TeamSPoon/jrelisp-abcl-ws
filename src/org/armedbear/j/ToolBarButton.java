...
public final class ToolBarButton extends JButton implements ActionListener, MouseListener {
	private Frame frame;

	public ToolBarButton(Frame frame, String actionCommand, ActionListener listener) {
		super();
		this.frame = frame;
