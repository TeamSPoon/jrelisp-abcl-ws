...
public final class FilenameCompletion {
	...
	public FilenameCompletion(File directory, String prefix, String sourcePath, boolean ignoreCase) {
			...
			if (dir != null && dir.isDirectory()) {
				...
				if (sourcePath != null) {
					...
					for (int i = 0; i < sourcePathDirectories.size(); i++) {
						File sourcePathDirectory = File.getInstance((String) sourcePathDirectories.get(i));
