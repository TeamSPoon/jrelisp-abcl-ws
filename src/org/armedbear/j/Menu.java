...
public final class Menu extends JMenu implements Constants {
	...
	public MenuItem add(Editor editor, String label, char mnemonic, String command, boolean enabled) {
	...
	public MenuItem add(Editor editor, String label, char mnemonic, String command) {
