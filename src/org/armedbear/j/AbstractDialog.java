...
public abstract class AbstractDialog extends JDialog implements ActionListener, KeyListener, WindowListener {
	...
	// Add label and text field below it with right amount of space between
	// them.
	...
	protected void centerDialog() {
		...
		if (owner != null) {
			...
			p = new Point((parent.width - window.width) / 2, (parent.height - window.height) / 2);
		}
		setLocation(p);
	}
}
