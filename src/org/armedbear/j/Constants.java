 ...
 * Constants.java
 *
 * Copyright (C) 2002-2015 Peter Graves <gnooth@gmail.com>
 *
...
public interface Constants {
	...
	int CHECKIN_MODE = 6;
	String CHECKIN_MODE_NAME = "Checkin";
	int COMPILATION_MODE = 7;
	String COMPILATION_MODE_NAME = "Compilation";
	int CPP_MODE = 8;
	String CPP_MODE_NAME = "C++";
	int CSS_MODE = 9;
	String CSS_MODE_NAME = "CSS";
	int C_MODE = 10;
	String C_MODE_NAME = "C";
	int DIFF_MODE = 11;
	String DIFF_MODE_NAME = "Diff";
	int DIRECTORY_MODE = 12;
	String DIRECTORY_MODE_NAME = "Directory";
	int FORTH_MODE = 13;
	String FORTH_MODE_NAME = "Forth";
	int HTML_MODE = 14;
	String HTML_MODE_NAME = "HTML";
	int IMAGE_MODE = 15;
	String IMAGE_MODE_NAME = "Image";
	int JAVASCRIPT_MODE = 16;
	String JAVASCRIPT_MODE_NAME = "JavaScript";
	int JAVA_MODE = 17;
	String JAVA_MODE_NAME = "Java";
	int JDB_MODE = 18;
	String JDB_MODE_NAME = "JDB";
	int LISP_MODE = 19;
	String LISP_MODE_NAME = "Lisp";
	int LISP_SHELL_MODE = 20;
	String LISP_SHELL_MODE_NAME = "Lisp Shell";
	int LIST_OCCURRENCES_MODE = 21;
	String LIST_OCCURRENCES_MODE_NAME = "List Occurrences";
	int LIST_REGISTERS_MODE = 22;
	String LIST_REGISTERS_MODE_NAME = "List Registers";
	int LIST_TAGS_MODE = 23;
	String LIST_TAGS_MODE_NAME = "List Tags";
	int MAILBOX_MODE = 24;
	String MAILBOX_MODE_NAME = "Mailbox";
	int MAKEFILE_MODE = 25;
	String MAKEFILE_MODE_NAME = "Makefile";
	int MAN_MODE = 26;
	String MAN_MODE_NAME = "Man";
	int MESSAGE_MODE = 27;
	String MESSAGE_MODE_NAME = "Message";
	int NEWS_GROUPS_MODE = 28;
	...
	int PHP_MODE = 32;
	String PHP_MODE_NAME = "PHP";
	int PLAIN_TEXT_MODE = 33;
	String PLAIN_TEXT_MODE_NAME = "Plain Text";
	int PROPERTIES_MODE = 34;
	String PROPERTIES_MODE_NAME = "Properties";
	int PYTHON_MODE = 35;
