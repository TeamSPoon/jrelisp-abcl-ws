...
public class IdleThread extends Thread {
	...
	private IdleThreadTask updateSidebarTask = new IdleThreadTask(updateSidebarRunnable, 500, true);
	...
	private IdleThreadTask parseBuffersTask = new IdleThreadTask(parseBuffersRunnable, 500, false);
	...
	private IdleThreadTask updateHorizontalScrollBarsTask = new IdleThreadTask(updateHorizontalScrollBarsRunnable, 500,
			true);
	...
	private IdleThreadTask autosaveTask = new IdleThreadTask(autosaveRunnable, 2000, false);
	...
	private IdleThreadTask saveStateTask = new IdleThreadTask(saveStateRunnable, 5000, true);

	private IdleThreadTask gcTask = new GarbageCollectionTask();

	private IdleThreadTask tagCurrentDirectoryTask = new TagCurrentDirectoryTask();
	...
	private void addListThreadsTask() {
		Runnable listThreadsRunnable = new Runnable() {
			...
			public void run() {
				int minutes = Editor.preferences().getIntegerProperty(Property.LIST_THREADS);
				if (minutes > 0) {
