...
public final class SessionProperties {
		...
		if (prefix != null) {
			if (frame.getSidebar() != null) {
				...
				if (dividerLocation >= 0) {
					...
					setIntegerProperty(prefix.concat("sidebar.dividerLocation"), dividerLocation);
				}
			}
			setBooleanProperty(prefix.concat("sidebar.show"), frame.getSidebar() != null);
		}
	}
	...
	public boolean getShowSidebar(Frame frame) {
		...
		String prefix = getPrefix(frame);
		if (prefix != null)
			toBeReturned = getBooleanProperty(prefix.concat("sidebar.show"), toBeReturned);
		return toBeReturned;
	}
	...
	public int getSidebarWidth(Frame frame) {
		...
		String prefix = getPrefix(frame);
		if (prefix != null)
			toBeReturned = getIntegerProperty(prefix.concat("sidebar.width"), toBeReturned);
		return toBeReturned;
	}
	...
	public int getSidebarDividerLocation(Frame frame) {
		...
		String prefix = getPrefix(frame);
		if (prefix != null)
			toBeReturned = getIntegerProperty(prefix.concat("sidebar.dividerLocation"), toBeReturned);
		return toBeReturned;
	}
