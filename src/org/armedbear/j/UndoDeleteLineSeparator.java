 ...
 * $Id: UndoDeleteLineSeparator.java,v 1.4 2003/06/11 15:05:59 piso Exp $
 *
...
public final class UndoDeleteLineSeparator extends AbstractUndoableEdit implements Constants, UndoableEdit {
	...
	public void undo() {
		...
		if (postState.modificationCount != preState.modificationCount) {
			// Buffer was changed.
			buffer.invalidate();
			Sidebar.setUpdateFlagInAllFrames(SIDEBAR_MODIFIED_BUFFER_COUNT | SIDEBAR_REPAINT_BUFFER_LIST);
