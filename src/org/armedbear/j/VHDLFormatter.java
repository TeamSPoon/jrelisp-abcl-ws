 ...
 * $Id: VHDLFormatter.java,v 1.1.1.1 2002/09/24 16:09:20 piso Exp $
 *
...
public final class VHDLFormatter extends Formatter implements Constants {
	...
	private static final String[] types = { "bit", "bit_vector", "boolean", "character", "delay_length",
			"file_open_kind", "file_open_status", "integer", "line", "natural", "positive", "real", "severity_level",
			"side", "signed", "std_logic", "std_logic_vector", "std_ulogic", "std_ulogic_vector", "string", "text",
			"time", "unsigned" };
}
