 ...
 * $Id: BrowseFile.java,v 1.1.1.1 2002/09/24 16:08:23 piso Exp $
 *
...
public final class BrowseFile implements Constants {
	public static void browseFileAtDot() {
		String browser = Editor.preferences().getStringProperty(Property.BROWSER);
		if (browser == null)
			browser = "j";
		...
		// External browser.
		String browserOpts = Editor.preferences().getStringProperty(Property.BROWSER_OPTS);
		try {
			if (browserOpts != null) {
