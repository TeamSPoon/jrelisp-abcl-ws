 ...
 * $Id: SaveFileDialog.java,v 1.5 2004/09/12 23:49:03 piso Exp $
 *
...
public class SaveFileDialog extends JDialog implements FocusListener, KeyListener {
	...
	private Vector getCompletions(String prefix) {
		...
		if (Utilities.isFilenameAbsolute(prefix) || prefix.indexOf(LocalFile.getSeparatorChar()) >= 0) {
	...
	public static File getSaveFile(Editor editor, String dialogTitle) {
		...
		SaveFileDialog d = new SaveFileDialog(editor, dialogTitle, "File:", defaultName);
