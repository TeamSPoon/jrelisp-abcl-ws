...
public class Git implements Constants {
	...
	private static void gitCompleted(Editor editor, Buffer parentBuffer, String cmd, String output) {
	...
	private static boolean checkGitInstalled() {
		if (haveGit())
			return true;
		MessageDialog.showMessageDialog("The git command-line client does not appear to be in your PATH.", "Error");
		return false;
	}
