 ...
 * $Id: JavaContext.java,v 1.1.1.1 2002/09/24 16:09:21 piso Exp $
 *
...
public final class JavaContext implements Constants {
	...
	private static final RE parameterRE = new UncheckedRE("^(\\w+\\s+\\w+\\s*,?)");
	private static final RE declarationRE = new UncheckedRE("^(\\w+\\s+\\w+\\s*;|\\w+\\s+\\w+\\s*=[^=])");
