 ...
 * $Id: AlignStrings.java,v 1.1.1.1 2002/09/24 16:08:01 piso Exp $
 *
...
public final class AlignStrings {
	public static void alignStrings() {
		...
		InputDialog d = new InputDialog(editor, "Regular Expression:", "Align Strings", null);
	...
	private static void _alignStrings(Editor editor, Buffer buffer, Region region, RE re) {
		int maxCol = -1;
			...
			if (text != null) {
				...
				if (match != null) {
					...
					if (col < maxCol) {
						...
						buffer.insertChars(editor.getDot(), Utilities.spaces(maxCol - col));
