...
public final class LocationBar extends JPanel implements Constants, ActionListener, MouseListener {
	private Editor editor;
	private final Label label;
	private final HistoryTextField textField;
	private JButton closeButton;

	private static String[] prompts = { "Location:", "Command:", "Tag:", "Pattern:", };
