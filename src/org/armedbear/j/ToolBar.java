...
public class ToolBar extends JToolBar implements ActionListener, ToolBarConstants {
	...
	public ToolBarButton addButton(String text, String iconFile, String methodName, boolean enabled) {
	...
	private static final boolean textEnabled() {
		...
		return preferences.getBooleanProperty(Property.TOOL_BAR_SHOW_TEXT, Editor.lookAndFeel == null);
	}
	...
	public static final boolean isRolloverEnabled() {
		// Defaults to true for j's default look and feel.
		return preferences.getBooleanProperty(Property.TOOL_BAR_IS_ROLLOVER, Editor.lookAndFeel == null);
	}
