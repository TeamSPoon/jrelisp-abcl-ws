...
public class SidebarTagList extends SidebarList
		implements Constants, NavigationComponent, KeyListener, MouseListener, MouseMotionListener {
	...
	public synchronized void refresh() {
		...
		Thread thread = new Thread(runTaggerRunnable, "SidebarTagList.refresh()");
