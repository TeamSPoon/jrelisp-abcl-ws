...
public class FindInFilesDialog extends AbstractDialog
		implements Constants, ActionListener, FocusListener, TextListener {
	...
	private ModeListEntry[] getPermissibleModes() {
		if (permissibleModes == null) {
			...
			permissibleModes = (ModeListEntry[]) list.toArray(new ModeListEntry[list.size()]);
		}
