...
public final class ModeList implements Constants {
	...
	private ModeList() {
		...
		addEntry(CPP_MODE, CPP_MODE_NAME, "CppMode", true,
		...
		addEntry(FORTH_MODE, FORTH_MODE_NAME, "ForthMode", true, ".+\\.forth|.+\\.fs|.+\\.f");
		...
		addEntry(PROPERTIES_MODE, PROPERTIES_MODE_NAME, "PropertiesMode", true,
		...
		addEntry(SHELL_SCRIPT_MODE, SHELL_SCRIPT_MODE_NAME, "ShellScriptMode", true,
	...
	private final void addEntry(int id, String displayName, String className, boolean selectable, String defaultFiles) {
