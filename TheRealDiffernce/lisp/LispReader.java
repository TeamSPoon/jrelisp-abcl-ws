...
public final class LispReader
{
                                ...
                                "stream character")
    {
        ...
        {
    if(true)   return stream.readString(terminator, Stream.currentReadtable);
                                  ...
                                  "stream sub-char numarg")
    {
        ...
        {
           if(true)  return stream.readSharpLeftParen(c, n, Stream.currentReadtable);
final LispThread thread = LispThread.currentThread();
                                  ...
                                  "stream sub-char numarg")
    {
        ...
        {
          if(true)return stream.readSharpStar(ignored, n, Stream.currentReadtable);
