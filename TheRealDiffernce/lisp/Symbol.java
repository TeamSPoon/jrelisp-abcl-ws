 ...
 * $Id: Symbol.java,v 1.252 2007/10/13 14:03:34 piso Exp $
 *
...
public class Symbol extends LispObject implements java.io.Serializable
{
...

  {
    LispObject fun;
    if ((fun = function) == null)
        return undefinedFunction(list3(first, second, third));
...

  {
    LispObject fun;
    if ((fun = function) == null)
        return undefinedFunction(list4(first, second, third, fourth));
...

  {
    LispObject fun;
    if ((fun = function) == null)
        return undefinedFunction(list5(first, second, third, fourth,
                                      fifth));
...

  {
    LispObject fun;
    if ((fun = function) == null)
        return undefinedFunction(list6(first, second, third, fourth,
                                      fifth, sixth));
...

  {
    LispObject fun;
    if ((fun = function) == null)
        return undefinedFunction(list8(first, second, third, fourth,
