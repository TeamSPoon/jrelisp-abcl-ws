 ...
 * excepti`on statement from your version.
 */
...
public class TypeError extends LispError
{
        ...
        new Primitive(Symbol.TYPE_ERROR_DATUM, "condition")
    {
        ...
        public LispObject execute(LispObject arg)
        {
            ...
            return checkStandardObject(obj).getInstanceSlotValue(Symbol.DATUM);
        }
    };
        ...
        new Primitive(Symbol.TYPE_ERROR_EXPECTED_TYPE, "condition")
    {
        ...
        public LispObject execute(LispObject arg)
        {
            return checkStandardObject(obj).getInstanceSlotValue(Symbol.EXPECTED_TYPE);
        }
    };
}
